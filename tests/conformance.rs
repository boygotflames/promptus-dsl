...
const BENCH_GENERIC_EXTRACTOR_BASELINE: &str = "provider: generic\ntokenizer: cl100k_base\nsource   | bytes=230 | tokens=57 | delta_bytes=+0 | delta_tokens=+0 | delta_bytes_vs_baseline=-4 | delta_tokens_vs_baseline=+3\nbaseline | bytes=234 | tokens=54 | delta_bytes=+4 | delta_tokens=-3 | delta_bytes_vs_baseline=+0 | delta_tokens_vs_baseline=+0\nplain    | bytes=233 | tokens=60 | delta_bytes=+3 | delta_tokens=+3 | delta_bytes_vs_baseline=-1 | delta_tokens_vs_baseline=+6\njson-ir  | bytes=312 | tokens=89 | delta_bytes=+82 | delta_tokens=+32 | delta_bytes_vs_baseline=+78 | delta_tokens_vs_baseline=+35\nshadow   | bytes=202 | tokens=49 | delta_bytes=-28 | delta_tokens=-8 | delta_bytes_vs_baseline=-32 | delta_tokens_vs_baseline=-5";
const BENCH_GENERIC_JSON_OUTPUT_BASELINE: &str = "provider: generic\ntokenizer: cl100k_base\nsource   | bytes=141 | tokens=42 | delta_bytes=+0 | delta_tokens=+0 | delta_bytes_vs_baseline=-15 | delta_tokens_vs_baseline=+1\nbaseline | bytes=156 | tokens=41 | delta_bytes=+15 | delta_tokens=-1 | delta_bytes_vs_baseline=+0 | delta_tokens_vs_baseline=+0\nplain    | bytes=140 | tokens=41 | delta_bytes=-1 | delta_tokens=-1 | delta_bytes_vs_baseline=-16 | delta_tokens_vs_baseline=+0\njson-ir  | bytes=215 | tokens=72 | delta_bytes=+74 | delta_tokens=+30 | delta_bytes_vs_baseline=+59 | delta_tokens_vs_baseline=+31\nshadow   | bytes=126 | tokens=39 | delta_bytes=-15 | delta_tokens=-3 | delta_bytes_vs_baseline=-30 | delta_tokens_vs_baseline=-2";
...
const BENCH_ANTHROPIC_MINIMAL: &str = "provider: anthropic\ntokenizer: o200k_base\nsource  | bytes=95 | tokens=27 | delta_bytes=+0 | delta_tokens=+0\nplain   | bytes=94 | tokens=26 | delta_bytes=-1 | delta_tokens=-1\njson-ir | bytes=141 | tokens=46 | delta_bytes=+46 | delta_tokens=+19\nshadow  | bytes=129 | tokens=39 | delta_bytes=+34 | delta_tokens=+12";
const BENCH_ANTHROPIC_EXTRACTOR: &str = "provider: anthropic\ntokenizer: o200k_base\nsource  | bytes=230 | tokens=58 | delta_bytes=+0 | delta_tokens=+0\nplain   | bytes=233 | tokens=61 | delta_bytes=+3 | delta_tokens=+3\njson-ir | bytes=312 | tokens=90 | delta_bytes=+82 | delta_tokens=+32\nshadow  | bytes=313 | tokens=85 | delta_bytes=+83 | delta_tokens=+27";
const BENCH_ANTHROPIC_JSON_OUTPUT: &str = "provider: anthropic\ntokenizer: o200k_base\nsource  | bytes=141 | tokens=41 | delta_bytes=+0 | delta_tokens=+0\nplain   | bytes=140 | tokens=40 | delta_bytes=-1 | delta_tokens=-1\njson-ir | bytes=215 | tokens=71 | delta_bytes=+74 | delta_tokens=+30\nshadow  | bytes=169 | tokens=51 | delta_bytes=+28 | delta_tokens=+10";
const BENCH_ANTHROPIC_QUOTED: &str = "provider: anthropic\ntokenizer: o200k_base\nsource  | bytes=135 | tokens=44 | delta_bytes=+0 | delta_tokens=+0\nplain   | bytes=136 | tokens=43 | delta_bytes=+1 | delta_tokens=-1\njson-ir | bytes=186 | tokens=64 | delta_bytes=+51 | delta_tokens=+20\nshadow  | bytes=155 | tokens=51 | delta_bytes=+20 | delta_tokens=+7";
