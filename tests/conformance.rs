...
const BENCH_GENERIC_EXTRACTOR_BASELINE: &str = "provider: generic\ntokenizer: cl100k_base\nsource   | bytes=230 | tokens=57 | delta_bytes=+0 | delta_tokens=+0 | delta_bytes_vs_baseline=+13 | delta_tokens_vs_baseline=+3\nbaseline | bytes=217 | tokens=54 | delta_bytes=-13 | delta_tokens=-3 | delta_bytes_vs_baseline=+0 | delta_tokens_vs_baseline=+0\nplain    | bytes=233 | tokens=60 | delta_bytes=+3 | delta_tokens=+3 | delta_bytes_vs_baseline=+16 | delta_tokens_vs_baseline=+6\njson-ir  | bytes=312 | tokens=89 | delta_bytes=+82 | delta_tokens=+32 | delta_bytes_vs_baseline=+95 | delta_tokens_vs_baseline=+35\nshadow   | bytes=202 | tokens=49 | delta_bytes=-28 | delta_tokens=-8 | delta_bytes_vs_baseline=-15 | delta_tokens_vs_baseline=-5";
const BENCH_GENERIC_JSON_OUTPUT_BASELINE: &str = "provider: generic\ntokenizer: cl100k_base\nsource   | bytes=141 | tokens=42 | delta_bytes=+0 | delta_tokens=+0 | delta_bytes_vs_baseline=-2 | delta_tokens_vs_baseline=+1\nbaseline | bytes=143 | tokens=41 | delta_bytes=+2 | delta_tokens=-1 | delta_bytes_vs_baseline=+0 | delta_tokens_vs_baseline=+0\nplain    | bytes=140 | tokens=41 | delta_bytes=-1 | delta_tokens=-1 | delta_bytes_vs_baseline=-3 | delta_tokens_vs_baseline=+0\njson-ir  | bytes=215 | tokens=72 | delta_bytes=+74 | delta_tokens=+30 | delta_bytes_vs_baseline=+72 | delta_tokens_vs_baseline=+31\nshadow   | bytes=126 | tokens=39 | delta_bytes=-15 | delta_tokens=-3 | delta_bytes_vs_baseline=-17 | delta_tokens_vs_baseline=-2";
